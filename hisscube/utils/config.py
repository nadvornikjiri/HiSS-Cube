...
class Config:
    ...
    def parse_config(self):
        ...
        self.CREATE_VISUALIZATION_CUBE = self.config.getboolean("Writer", "CREATE_VISUALIZATION_CUBE")
        self.CREATE_ML_CUBE = self.config.getboolean("Writer", "CREATE_ML_CUBE")

...
from hisscube.Reader import Reader
from hisscube.astrometry import NoCoverageFoundError, get_optimized_wcs
from ast import literal_eval as make_tuple


class Writer(H5Handler):
    ...
    def __init__(self, h5_file=None, cube_utils=None):
        ...
        """
        super(Writer, self).__init__(h5_file, cube_utils)
        ...
        self.REBIN_FLAG = self.config.getboolean("Preprocessing", "APPLY_REBIN")
    ...
    def ingest_spectrum(self, spec_path):
        ...
        self.metadata, self.data = self.cube_utils.get_multiple_resolution_spectrum(
            spec_path, self.SPEC_MIN_RES,
            apply_rebin=self.REBIN_FLAG,
    ...
    def create_dense_cube(self):
        ...
        """
        reader = Reader(self.f, self.cube_utils)
        spectral_cube = reader.get_spectral_cube_from_orig_for_res(0)
